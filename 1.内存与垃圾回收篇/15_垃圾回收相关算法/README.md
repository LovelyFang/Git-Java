...
<img src="images/image-20200712103230349.png" alt="image-20200712103230349" style="zoom:67%;" />
...
相对于引用计数算法而言，<a>可达性分析算法</a>不仅同样具备实现简单和执行高效等特点，更重要的是该算法可以有效地解决在引用计数算法中循环引用的问题，防止内存泄漏的发生。
...
<img src="images/image-20200712104312406.png" alt="image-20200712104312406" style="zoom:80%;" />
...
![2021-03-20_10-57-10](D:\StudyFile\Java\JVM\1_内存与垃圾回收篇\15_垃圾回收相关算法\images\2021-03-20_10-57-10.png)
