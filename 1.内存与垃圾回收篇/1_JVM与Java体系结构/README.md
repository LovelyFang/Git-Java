...
![2021-03-13_12-29-10](D:\StudyFile\Java\JVM\1_内存与垃圾回收篇\1_JVM与Java体系结构\images\2021-03-13_12-29-10.png)
...
![image-202103011226](D:\StudyFile\Java\JVM\1_内存与垃圾回收篇\1_JVM与Java体系结构\images\image-202103011226.png)
...
- 性能优秀和执行更高效
- 花费更少的指令去完成一项操作。
- 在大部分情况下，基于寄存器架构的指令集往往都以一地址指令、二地址指令和三地址指令为主，而基于栈式架构的指令集却是以零地址指令为主要方式
